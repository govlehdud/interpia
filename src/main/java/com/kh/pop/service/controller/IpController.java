...
import com.kh.pop.service.model.vo.IpFileInfo;
...
public class IpController {
		...
		public String ipdetail(@RequestParam("page")int page,@RequestParam("bId")int bId, Model model, HttpServlet request) throws Exception {
			...
			if(IpBoard != null) {
				IpFileInfo fi = ipService.scdetailFile(bId);
		...
		public ModelAndView loginBtn(@ModelAttribute Member vo,  HttpServletRequest request,
				Integer page, ModelAndView mv,HttpSession session) throws Exception {
